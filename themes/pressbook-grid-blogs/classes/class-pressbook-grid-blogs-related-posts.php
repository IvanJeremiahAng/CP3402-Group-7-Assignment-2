 ...
 */
class PressBook_Grid_Blogs_Related_Posts extends PressBook\Options {
	/**
	...
	public function sec_posts_related( $wp_customize ) {
		$wp_customize->add_section(
			'sec_posts_related',
			array(
				'title'       => esc_html__( 'Related Posts', 'pressbook-grid-blogs' ),
				'description' => esc_html__( 'You can customize the related posts options in here.', 'pressbook-grid-blogs' ),
				'priority'    => 158,
			)
		);
	}
	...
	public function set_related_posts_enable( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'type'    => 'checkbox',
				'label'   => esc_html__( 'Enable Related Posts', 'pressbook-grid-blogs' ),
			)
		);
	}
	...
	public function set_related_posts_title( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				'section'     => 'sec_posts_related',
				'type'        => 'text',
				'label'       => esc_html__( 'Related Posts Title', 'pressbook-grid-blogs' ),
				'description' => esc_html__( 'You can change the heading of the related posts that is shown below the single post content.', 'pressbook-grid-blogs' ),
			)
		);
	}
	...
	public function set_related_posts_source( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'type'        => 'select',
				'choices'     => array(
					'categories' => esc_html__( 'Categories', 'pressbook-grid-blogs' ),
					'tags'       => esc_html__( 'Tags', 'pressbook-grid-blogs' ),
				),
				'label'       => esc_html__( 'Related Posts Based On', 'pressbook-grid-blogs' ),
				'description' => esc_html__( 'Select the source for related posts to display. Default: Categories', 'pressbook-grid-blogs' ),
			)
		);
	}
	...
	public function set_related_posts_count( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'type'        => 'select',
				'choices'     => $this->count(),
				'label'       => esc_html__( 'Related Posts Count', 'pressbook-grid-blogs' ),
				'description' => esc_html__( 'Set the number of related posts. Default: 6', 'pressbook-grid-blogs' ),
			)
		);
	}
	...
	public function set_related_posts_order( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'type'        => 'select',
				'choices'     => $this->order(),
				'label'       => esc_html__( 'Related Posts Order', 'pressbook-grid-blogs' ),
				'description' => esc_html__( 'Designates the ascending or descending order. Default: Latest First', 'pressbook-grid-blogs' ),
			)
		);
	}
	...
	public function set_related_posts_orderby( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				...
				'label'       => esc_html__( 'Related Posts Order By', 'pressbook-grid-blogs' ),
				'description' => esc_html__( 'Sort retrieved related posts by parameter. Default: Random Order', 'pressbook-grid-blogs' ),
			)
		);
	}
	...
	public function set_related_posts_taxonomy( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				'section'     => 'sec_posts_related',
				'type'        => 'checkbox',
				'label'       => esc_html__( 'Show Taxonomy On Hover', 'pressbook-grid-blogs' ),
				'description' => esc_html__( 'Whether to show the post category or tag on hover.', 'pressbook-grid-blogs' ),
			)
		);
	}
	...
	public function source() {
		return array(
			''           => esc_html__( 'All Posts', 'pressbook-grid-blogs' ),
			'categories' => esc_html__( 'Posts from Selected Categories', 'pressbook-grid-blogs' ),
			'tags'       => esc_html__( 'Posts from Selected Tags', 'pressbook-grid-blogs' ),
		);
	}
	...
	public function count() {
		return array(
			'1'  => esc_html_x( '1', 'Related Posts Count', 'pressbook-grid-blogs' ),
			'2'  => esc_html_x( '2', 'Related Posts Count', 'pressbook-grid-blogs' ),
			'3'  => esc_html_x( '3', 'Related Posts Count', 'pressbook-grid-blogs' ),
			'4'  => esc_html_x( '4', 'Related Posts Count', 'pressbook-grid-blogs' ),
			'5'  => esc_html_x( '5', 'Related Posts Count', 'pressbook-grid-blogs' ),
			'6'  => esc_html_x( '6', 'Related Posts Count', 'pressbook-grid-blogs' ),
			'7'  => esc_html_x( '7', 'Related Posts Count', 'pressbook-grid-blogs' ),
			'8'  => esc_html_x( '8', 'Related Posts Count', 'pressbook-grid-blogs' ),
			'9'  => esc_html_x( '9', 'Related Posts Count', 'pressbook-grid-blogs' ),
			'10' => esc_html_x( '10', 'Related Posts Count', 'pressbook-grid-blogs' ),
			'11' => esc_html_x( '11', 'Related Posts Count', 'pressbook-grid-blogs' ),
			'12' => esc_html_x( '12', 'Related Posts Count', 'pressbook-grid-blogs' ),
		);
	}
	...
	public function order() {
		return array(
			'desc' => esc_html__( 'Latest First', 'pressbook-grid-blogs' ),
			'asc'  => esc_html__( 'Oldest First', 'pressbook-grid-blogs' ),
		);
	}
	...
	public function orderby() {
		return array(
			'rand'     => esc_html__( 'Random Order', 'pressbook-grid-blogs' ),
			'date'     => esc_html__( 'Post Date', 'pressbook-grid-blogs' ),
			'modified' => esc_html__( 'Last Modified Date', 'pressbook-grid-blogs' ),
		);
	}
}
